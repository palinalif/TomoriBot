...
export const NVIDIA_EMBEDDINGS_URL =
  "https://integrate.api.nvidia.com/v1/embeddings";
export const NVIDIA_IMAGE_GENERATION_URL =
...
export const NVIDIA_DEFAULT_IMAGE_MODEL =
...
export const NVIDIA_STRUCTURED_OUTPUT_VISION_MODELS = new Set([
  "qwen/qwen3.5-397b-a17b",
]);
