...
export function getEffectiveLlmModelName(llm: LlmRow, customModelName?: string | null): string {
...
export function getLlmDisplayName(llm: LlmRow, customModelName?: string | null): string {
  return getEffectiveLlmModelName(llm, customModelName);
}

export function formatLlmDisplayLabel(llm: LlmRow, customModelName?: string | null): string {
