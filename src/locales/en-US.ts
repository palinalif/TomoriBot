    ...
    config: {
      ...
      logitbias: {
        ...
        add: {
          ...
          terms_description: `Comma-separated values. Example: Sorry, apology, 50256`,
          ...
          success_description: `Added **{added_count}** new entr(y/ies) and updated **{updated_count}** existing entr(y/ies).\nTotal saved: **{total_count}**\nRuntime-ready token IDs: **{runtime_ready_count}**`,
        },
        remove: {
          ...
          success_description: `Removed **{removed_count}** entr(y/ies). **{remaining_count}** entr(y/ies) remain saved.`,
