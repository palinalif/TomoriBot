...
Discord API Latency: \`{discord_response}ms\``,
		...
		teach: {
			sampledialogue: {
				...
				user_input_description: `A sample question for the bot`,
				user_input_placeholder: `What's your favorite food?`,
				bot_input_label: `My Response`,
				bot_input_description: `How the bot should respond`,
...
> {bot_input}`, // Natural line breaks here
			...
			attribute: {
				...
				modal_description: `A personality trait that I have for this server`,
