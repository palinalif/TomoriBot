    ...
    openrouter: {
      ...
      models: {
        ...
        add: {
          ...
          success_description: `Registered OpenRouter model \`{model_name}\` for this server. It now appears in the normal OpenRouter model picker.`,
          already_registered_title: `Model Already Registered`,
          already_registered_description: `OpenRouter model \`{model_name}\` is already registered for this server.`,
          already_available_title: `Already Available`,
          already_available_description: `OpenRouter model \`{model_name}\` is already built in. No extra registration is needed.`,
        ...
        remove: {
          ...
          model_name_description: `Exact registered OpenRouter model codename to remove.`,
          success_title: `OpenRouter Model Removed`,
          success_description: `Removed OpenRouter model \`{model_name}\` from this server's saved OpenRouter model list.`,
          success_still_referenced_description: `Removed OpenRouter model \`{model_name}\` from this server's saved OpenRouter model list. Existing selections that already use it were left unchanged, so switch away from them manually if you no longer want to use it.`,
          not_found_description: `No registered OpenRouter model named \`{model_name}\` was found for this server.`,
    ...
    config: {
      ...
      custom_models: {
        ...
        add: {
          ...
          label_description: `Saved nickname for this endpoint inside Tomori, e.g. KoboldCPP.`,
          ...
          model_name_description: `Exact remote model ID; some endpoints require the exact codename to work properly.`,
    ...
    personal: {
      ...
      openrouter_models: {
        ...
        add: {
          ...
          success_description: `Registered OpenRouter model \`{model_name}\` for your personal provider list. It now appears in the normal OpenRouter model picker.`,
          already_registered_title: `Model Already Registered`,
          already_registered_description: `OpenRouter model \`{model_name}\` is already registered for your personal provider list.`,
          already_available_title: `Already Available`,
          already_available_description: `OpenRouter model \`{model_name}\` is already built in. No extra registration is needed.`,
          not_found_title: `Model Not Found`,
          not_found_description: `Could not find OpenRouter model \`{model_name}\`. Use the exact OpenRouter codename and try again.`,
        ...
        remove: {
          ...
          success_description: `Removed OpenRouter model \`{model_name}\` from your personal saved OpenRouter model list.`,
          success_still_referenced_description: `Removed OpenRouter model \`{model_name}\` from your personal saved OpenRouter model list. Existing selections that already use it were left unchanged, so switch away from them manually if you no longer want to use it.`,
          not_found_description: `No registered OpenRouter model named \`{model_name}\` was found in your personal provider list.`,
          already_available_title: `Built-In Model`,
          already_available_description: `OpenRouter model \`{model_name}\` is a built-in model and cannot be removed with this command.`,
        },
      },
