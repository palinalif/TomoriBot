  ...
  commands: {
    speech: {
      ...
      voice_remove: {
        ...
        select_sample_title: `Select Voice Sample to Remove`,
    ...
    help: {
      ...
      speech: {
        ...
        qwen3tts: {
          ...
          description: `Qwen3-TTS 12Hz Base is a local reference-audio clone path that expects plain speech text.`,
          steps_title: `Setup Steps`,
        ...
        irodoritts: {
          ...
          description: `IrodoriTTS is the Japanese-focused local clone path and expects plain speech text.`,
          steps_title: `Setup Steps`,
      ...
      transcription: {
        ...
        whisperx: {
          ...
          description: `WhisperX is the recommended local STT path.`,
          steps_title: `Setup Steps`,
    ...
    config: {
      ...
      "api-key": {
        ...
        set: {
          ...
          novelai_success_with_model_description: `The NovelAI API key has been successfully validated, encrypted, and saved. Your model has been automatically changed to \`{model_name}\`. ⚠️ **Emoji and sticker usage have been automatically disabled** to keep NovelAI's context lean and stable. You can re-enable them anytime with \`/config tool-use manage\`.`,
...
**{selected_count}** channel(s) are currently enabled.`,
      ...
      "user-blacklist": {
        ...
        add: {
          ...
          personalization_disabled_description: `Personalization is currently disabled server-wide. Enable it first with \`/config tool-use manage\`.`,
...
**Warning:** Personalization is currently disabled on this server, so this change won't affect my behavior here. It will still be reflected on other servers where personalization is enabled.`,
    ...
    generate: {
      image: {
        ...
        disabled_description: `Image generation is disabled on this server. A server member with \`Manage Server\` permissions can enable it using \`/config tool-use manage\`.`,
...
**Prompt:** {prompt}`,
        ...
        disabled_description: `Video generation is disabled on this server. A server member with \`Manage Server\` permissions can enable it using \`/config tool-use manage\`.`,
        wrong_provider_title: `🔴 Unsupported Provider`,
