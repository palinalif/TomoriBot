...
- Limit auto-trigger channels`,
      ...
      status: {
        ...
        field_pin_message: `Message Management Tool`,
...
- Export your persona to back it up or share with other servers!`,
    ...
    config: {
      ...
      permissions: {
        ...
        pinmessage_option: "Manage Messages",
        ...
        pinmessage_desc: "Allow pinning any recent message and editing/deleting Tomori-owned recent messages",
