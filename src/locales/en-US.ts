...
Restored now ({restored_count}): {restored_list}`,
      ...
      "tool-use": {
        ...
        set_description: `Enable or disable tool use for all models.`,
        already_set_title: `Tool Use Already Set`,
        already_enabled_description: `Tool use is already **enabled**.`,
        already_disabled_description: `Tool use is already **disabled**.`,
