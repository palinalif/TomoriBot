...
- Export your persona to back it up or share with other servers!`,
    ...
    conditioning: {
      ...
      toggle: {
        description: `Enable or disable conditioning prompt injection for a persona.`,
        ...
        already_enabled_description: `{persona_name}'s {type_label} is already enabled.`,
        already_disabled_description: `{persona_name}'s {type_label} is already disabled. New records are still stored.`,
        success_title: `Conditioning Updated`,
        enabled_success_description: `{persona_name} will now inject stored {type_label} reasons into prompt context.`,
        disabled_success_description: `{persona_name} will stop injecting {type_label} into prompt context, but new records will still be stored.`,
      },
      history: {
    ...
    server: {
      ...
      privatechannel: {
        ...
        remove: {
          description: `Review private channels and uncheck the ones you want to remove.`,
          ...
          checkbox_description: `Uncheck any private channels you want to remove.`,
          no_channels_title: `No Private Channels`,
          no_channels_description: `There are no private channels configured to remove.`,
          too_many_entries_title: `Too Many Private Channels`,
          too_many_entries_description: `There are {channel_count} private channels configured. This bulk modal supports up to {max_entries} channels across {max_groups} groups.`,
          no_changes_title: `No Private Channels Removed`,
          no_changes_description: `All private channels were left checked, so nothing was removed.`,
          success_title: `Private Channel Removed`,
          success_description: `Removed **{removed_count}** private channel(s): {removed_channels}\n**{remaining_count}** private channel(s) remain configured.`,
      ...
      rpchannel: {
        ...
        remove: {
          description: `Review RP channels and uncheck the ones you want to remove.`,
          ...
          checkbox_description: `Uncheck any RP channels you want to remove.`,
          no_channels_title: `No RP Channels`,
          no_channels_description: `There are no RP channels configured to remove.`,
          too_many_entries_title: `Too Many RP Channels`,
          too_many_entries_description: `There are {channel_count} RP channels configured. This bulk modal supports up to {max_entries} channels across {max_groups} groups.`,
          no_changes_title: `No RP Channels Removed`,
          no_changes_description: `All RP channels were left checked, so nothing was removed.`,
          success_title: `RP Channel Removed`,
          success_description: `Removed **{removed_count}** RP channel(s): {removed_channels}\n**{remaining_count}** RP channel(s) remain configured.`,
          not_found_title: `Channel Not Found`,
      ...
      welcomechannel: {
        description: `Configure a welcome channel for new member greetings.`,
        channel_description: `The text channel where new members should be greeted.`,
        action_description: `Whether to add or remove the welcome channel.`,
        ...
        added_title: `Welcome Channel Updated`,
        added_description: `I will now greet new members in {channel} using **{persona}**.`,
        removed_title: `Welcome Channel Removed`,
