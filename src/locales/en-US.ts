    ...
    help: {
      ...
      speech: {
        ...
        qwen3tts: {
          ...
          steps_title: `Setup Steps`,
          steps_description: `**Prerequisites**: Python 3.10+, CUDA 12.x + drivers (optional, for GPU)\n\n1. Create and activate a Python \`.venv\` in \`scripts/tts\`.\n2. Install \`requirements-qwen3tts.txt\`.\n3. *(GPU only)* Reinstall PyTorch: \`pip install torch torchaudio --index-url https://download.pytorch.org/whl/cu124\`\n4. Start \`qwen3tts_12hz_17b_base_server.py\`.\n5. Register with {custom_endpoint_add}: capability \`speech\`, api_style \`tts-clone\`, script_markup \`plain\`.\n6. Select with {model_speech}, then run {voice_add} and {voice_assign}.`,
        },
        irodoritts: {
          ...
          steps_title: `Setup Steps`,
          steps_description: `**Prerequisites**: Python 3.10+, CUDA 12.x + drivers (optional, for GPU)\n\n1. Create and activate a Python \`.venv\` in \`scripts/tts\`.\n2. Install \`requirements-irodori.txt\`.\n3. *(GPU only)* Reinstall PyTorch: \`pip install torch torchaudio --index-url https://download.pytorch.org/whl/cu124\`\n4. Start \`irodori_tts_server.py\`.\n5. Register with {custom_endpoint_add}: capability \`speech\`, api_style \`tts-clone\`, script_markup \`plain\`.\n6. Select with {model_speech}, then run {voice_add} and {voice_assign}.`,
        },
        elevenlabs: {
