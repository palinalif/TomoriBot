...
Discord API Latency: \`{discord_response}ms\``,
		...
		data: {
			...
			export: {
				...
				success_description_personality: `TomoriBot's personality has been exported and sent to your DMs!\n\n**Note:** This export is for informational purposes only. To import personalities, use the \`/preset\` commands instead.`,
				...
				dm_description_personality: `Here's the personality information you requested!\n\n**Note:** This text file is for informational purposes only. To import personalities into your server, use the \`/preset\` commands instead.`,
		...
		// Preset commands
		preset: {
			description: `Manage TomoriBot personality presets`,
			export: {
				description: `Export TomoriBot's personality as a shareable PNG file`,
				success_title: `✅ Preset Exported Successfully`,
				success_description: `TomoriBot preset **{nickname}** has been exported! Share this PNG file with others to spread this personality configuration.`,
				failed_title: `❌ Export Failed`,
				failed_description: `Failed to export the preset. Please try again later.`,
				...
				error_no_server_data: `Server not found in database. Please run /config setup first.`,
				error_no_preset_data: `Preset data not found. Please run /config setup first.`,
				error_validation_failed: `Failed to validate export data structure`,
				error_export_failed: `Failed to export preset data`,
			},
			import: {
				description: `Import a TomoriBot personality from a PNG file`,
				file_description: `PNG file containing TomoriBot preset data`,
				confirmation_description: `WARNING: This will REPLACE your current personality settings. Continue?`,
				confirmation_choice_yes: `Yes, replace my current preset`,
				confirmation_choice_no: `No, cancel import`,
				success_title: `✅ Preset Imported Successfully`,
				success_description: `Successfully imported preset **{nickname}**!\n📝 Attributes: {attribute_count}\n💬 Sample Dialogues: {dialogue_count}\n🔔 Trigger Words: {trigger_word_count}\n\n**Note:** Server avatar and nickname have also been updated if permissions allow.`,
				failed_title: `❌ Import Failed`,
				failed_description: `Failed to import the preset. Please check the file and try again.`,
				cancelled_title: `❌ Import Cancelled`,
				cancelled_description: `The import has been cancelled. No changes were made to your preset.`,
				invalid_file_type_title: `❌ Invalid File Type`,
				invalid_file_type_description: `Please upload a valid .png file containing TomoriBot preset data.`,
				file_too_large_title: `❌ File Too Large`,
				...
				no_metadata_title: `❌ No Preset Data Found`,
				no_metadata_description: `This PNG file doesn't contain TomoriBot preset data. Please use a file exported by \`/preset export\`.`,
				invalid_file_title: `❌ Invalid Preset File`,
				invalid_file_description: `The preset file format is invalid or incompatible.`,
				no_permission_title: `🔒 Permission Denied`,
				no_permission_description: `You need the **Manage Server** permission to import presets.`,
				...
				error_invalid_config: `Invalid configuration fields in preset data`,
				error_no_server_data: `Server not found in database. Please run /config setup first.`,
				error_import_failed: `Failed to import preset data`,
				...
				error_invalid_format: `Invalid preset file format`,
				error_invalid_type: `Invalid preset type: {type}. Expected "preset"`,
			...
			create: {
				...
				// Modal fields
				modal: {
					title: `Create Simple Preset (Tip: Use /preset generate for AI-powered creation!)`,
					character_name_label: `Character Name`,
					...
					example_user_description: `Tip: Add more examples with /teach sampledialogue after importing`,
				...
				success_description: `Your preset has been created for **{character_name}**!\n\n**Description:**\n{character_description}`,
