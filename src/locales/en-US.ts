...
export default {
	...
	genai: {
		...
		self_teach: {
			server_memory_learned_title: "🧠 I Learned Something New in this Server!",
			server_memory_learned_description:
				"`{memory_content}`",
			server_memory_updated_title: "📝 Updated Server Memory!",
	...
	commands: {
		...
		persona: {
			...
			import: {
				...
				memories_description: `Preserve this persona's memories about users?`,
				memories_choice_preserve: `Yes, preserve user memories`,
				memories_choice_fork: `No, start fresh user memories`,
...
> {bot_input}`, // Natural line breaks here
			...
			document: {
				...
				scope_description: `Choose whether this document is persona-only or shared server-wide.`,
