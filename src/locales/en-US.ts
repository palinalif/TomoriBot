...
4. (Optional) Use \`/server avatar\` to change the avatar if desired`,
    ...
    help: {
      ...
      speech: {
        ...
        title: `Speech Setup`,
        description_body: `Speech endpoints let TomoriBot send native Discord voice messages using either a local clone server or ElevenLabs.`,
        setup_field: `Setup`,
        setup_value: `Register a speech endpoint, add a voice sample for local clone engines, then assign a voice to each persona with \`/config speech voice-assign\`.`,
      },
      transcription: {
        description: `Learn how audio transcription works.`,
        title: `Transcription Setup`,
        description_body: `Transcription endpoints turn user audio attachments into text for conversation context.`,
        setup_field: `Setup`,
        setup_value: `Register an OpenAI-compatible transcription endpoint, then keep it selected as the server transcription model.`,
      },
      "custom-endpoint": {
        description: `Learn how custom endpoints work.`,
      },
