...
- Export your persona to back it up or share with other servers!`,
    ...
    novelai: {
      ...
      image: {
        ...
        generate: {
          ...
          prompt_description: `Imageboard-style prompt tags for the scene (for example: 1girl, solo, cafe, window light, detailed eyes).`,
    ...
    config: {
      ...
      humanizer: {
        ...
        choice_light: `1: Light (Default, Prompt Injection)`,
    ...
    server: {
      ...
      whitelist: {
        ...
        remove: {
          description: `Remove channels from whitelist`,
          modal_title: `Remove Channels from Whitelist`,
          ...
          too_many_channels_title: `Too Many Whitelisted Channels`,
          too_many_channels_description: `This server has more than **{max_channels}** whitelisted channels, which exceeds Discord's checkbox-group modal limit.`,
          no_removals_title: `No Channels Removed`,
          no_removals_description: `No channels were unchecked. The whitelist remains unchanged.`,
          success_title: `Channels Removed from Whitelist`,
          success_singular_description: `Channel **{channel_name}** has been removed from the whitelist.`,
          success_plural_description: `Removed **{removed_count}** channels from the whitelist: **{channels}**.`,
        },
      },
      cooldown: {
