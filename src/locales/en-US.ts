...
- Export your persona to back it up or share with other servers!`,
    ...
    novelai: {
      ...
      imggen: {
        description: `Manage server-wide NovelAI image generation parameter overrides.`,
        params: {
          ...
          invalid_scale_description: `Scale must be a number between {min} and {max}.`,
          ...
          invalid_cfg_rescale_title: `Invalid CFG Rescale`,
          invalid_cfg_rescale_description: `CFG rescale must be a number between {min} and {max}.`,
