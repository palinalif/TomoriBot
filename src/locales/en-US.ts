...
export default {
  ...
  genai: {
    ...
    image: {
      ...
      notice_inpaint_preset_line: `Inpaint preset: {preset}`,
      notice_reference_line: `Reference: {message_url}`,
...
{model_list}`,
      ...
      "image-parameters": {
        description: `Tune ComfyUI image generation parameters.`,
        target_description: `Choose which image generation path to tune.`,
        target_img2img: `Image-to-image`,
        target_tight: `Tight inpaint`,
        target_balanced: `Balanced inpaint`,
        target_loose: `Loose inpaint`,
        denoise_description: `Denoise 0-1. Defaults: img2img .40, tight .30, balanced .80, loose .90.`,
        cfg_description: `Inpaint CFG. Defaults: tight 8, balanced/loose 6.`,
        mask_threshold_description: `CLIPSeg threshold. Defaults: tight .45, balanced .28, loose .22.`,
        mask_grow_description: `Mask grow px. Defaults: tight 8, balanced 32, loose 48.`,
        mask_feather_description: `Mask blur. Defaults: tight 8, balanced 20, loose 28.`,
        reset_description: `Reset this target to env/default values.`,
        ...
        reset_label: `reset`,
        no_changes_title: `No Parameter Changes`,
        no_changes_description: `Set at least one parameter, or use reset to clear saved overrides.`,
        unsupported_title: `Unsupported Image Endpoint`,
        unsupported_description: `The active standard image model must be a server ComfyUI custom endpoint to tune these parameters.`,
        img2img_masks_title: `These Settings Need Inpaint`,
        img2img_masks_description: `Image-to-image only uses denoise here. Choose an inpaint target to change CFG or mask settings.`,
        success_title: `Image Parameters Updated`,
        success_description: `Updated **{target}** settings: {settings}`,
      },
      "image-preset": {
        description: `Create or update a custom ComfyUI inpaint preset.`,
        name_description: `Preset name. Use lowercase letters, numbers, hyphens, or underscores.`,
        preset_description_description: `When the model should use this preset, e.g. strong hair recolors or subtle accessory edits.`,
        denoise_description: `Inpaint denoise strength, 0-1.`,
        cfg_description: `Inpaint CFG guidance strength.`,
        mask_threshold_description: `CLIPSeg threshold for this preset.`,
        mask_grow_description: `Mask grow amount in pixels.`,
        mask_feather_description: `Mask blur/feather amount.`,
        remove_description: `Remove this custom preset instead of saving it.`,
        invalid_name_title: `Invalid Preset Name`,
        invalid_name_description: `Use 1-32 lowercase letters, numbers, hyphens, or underscores, starting with a letter or number.`,
        builtin_name_title: `Built-In Preset`,
        builtin_name_description: `Use \`/model image-parameters\` to tune built-in presets. Custom preset names must be different from tight, balanced, and loose.`,
        missing_values_title: `Preset Values Required`,
        missing_values_description: `To create or update a preset, provide description, denoise, cfg, mask_threshold, mask_grow, and mask_feather. Existing presets can be updated one field at a time after they have all values.`,
        unsupported_title: `Unsupported Image Endpoint`,
        unsupported_description: `The active standard image model must be a server ComfyUI custom endpoint to save custom presets.`,
        success_title: `Image Preset Saved`,
        success_description: `Saved custom preset \`{name}\`.\nDescription: {description}\nSettings: {settings}`,
        removed_title: `Image Preset Removed`,
        removed_description: `Removed custom preset \`{name}\`.`,
      },
      video: {
