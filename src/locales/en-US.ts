...
- Limit auto-trigger channels`,
			...
			status: {
				...
				server_page3_description: `Auto-chat, RP channels, whitelist, and scheduled random triggers`,
		...
		persona: {
			...
			export: {
				...
				export_json_description: `Export as a readable JSON file instead of PNG metadata`,
		...
		config: {
			...
			randomtrigger: {
				add: {
					...
					success_description: `I will check {channel} every **{timer_hours}h** with a **{chance}%** chance of speaking as **{persona}**.{silence_suffix}`,
