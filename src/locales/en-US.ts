...
- Export your persona to back it up or share with other servers!`,
    ...
    novelai: {
      tags: {
        ...
        style: {
          ...
          tags_input_description: `Comma-separated tags prepended to every NovelAI image prompt on this server. Leave empty to clear all style tags.`,
          ...
          cleared_title: `Style Tags Cleared`,
          cleared_description: `Cleared all server-wide NovelAI style tags.`,
        },
        negative: {
          ...
          tags_input_description: `Comma-separated negative tags used for this server's NovelAI generations. Leave empty to clear the server override and use the fallback negative prompt.`,
          ...
          cleared_title: `Negative Tags Cleared`,
          cleared_description: `Cleared the server-wide negative tag override. NovelAI generations will now use the fallback negative prompt.`,
        },
        me: {
    ...
    server: {
      ...
      autotrigger: {
        ...
        threshold: {
          description: `Set auto-chat message threshold (default: 0 disabled).`,
          threshold_description: `Messages before auto-chat (0 disabled/default, or 30-100).`,
