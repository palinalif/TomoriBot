...
Restored now ({restored_count}): {restored_list}`,
      ...
      "stop-strings": {
        description: `Manage provider stop strings.`,
        add: {
          description: `Add stop strings to a saved provider.`,
          strings_description: `Stop string(s) to add. Separate multiple entries with commas. Use \\n for newlines.`,
          picker_description: `Choose which saved provider to add these stop strings to.`,
          ...
          too_many_description: `This provider can store up to {max_count} stop strings. It currently has {current_count}, and this command would add {added_count}.`,
          no_changes_title: `No Stop Strings Added`,
          no_changes_description: `Those stop strings are already saved for this provider.`,
          success_title: `Stop Strings Added`,
          success_description: `Added {added_count} stop string(s) to **{provider}**: {stop_strings}`,
          more_added: `+{count} more`,
        },
        manage: {
          description: `Manage saved stop strings and the speaker-pattern stop behavior.`,
          picker_description: `Choose which saved provider to manage stop strings for.`,
          modal_title: `Manage Stop Strings`,
          speaker_pattern_checkbox_label: `Stop generation upon \\n{string}: pattern`,
          speaker_pattern_checkbox_description: `Unchecked by default. Enables speaker-label stop behavior such as "\\nName:".`,
          ...
          too_many_title: `Too Many Stop Strings`,
          too_many_description: `This provider has {count} stop strings, which exceeds the modal limit of {max_entries}.`,
          no_changes_title: `No Changes`,
          no_changes_description: `Stop string settings are already set to those choices.`,
          success_title: `Stop Strings Updated`,
          success_description: `Updated **{provider}** stop string settings.
