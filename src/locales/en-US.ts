	...
	commands: {
		...
		data: {
			...
			import: {
				...
				error_memory_critical_description: `The bot is currently experiencing high memory usage. Please try again in a moment.`,
		...
		persona: {
			...
			generate: {
				...
				error_memory_critical_title: `🛑 System Overloaded`,
				error_memory_critical_description: `The bot is currently experiencing high memory usage. Please try again in a moment.`,
				error_file_too_large: `Avatar image must be under 8 MB.`,
