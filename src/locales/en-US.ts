...
export default {
  general: {
    ...
    errors: {
      ...
      api_key_missing_description: `I need an active provider to function, but none is configured for this server. A server member with \`Manage Server\` permissions can set one using \`/config provider switch\`.`,
      api_key_error_title: `API Key Error`,
      api_key_error_description: `There was an issue accessing or decrypting the configured provider credentials. Please reconfigure them using \`/config provider switch\`.`,
...
Trigger Words ({trigger_word_count}): {triggers}`,
      ...
      generate: {
        ...
        wrong_provider_description: `Preset generation requires a compatible provider. Your current provider is **{current_provider}**. Please use \`/config provider switch\` to switch providers.`,
        no_api_key_title: `🔴 No API Key`,
        no_api_key_description: `No active provider is configured. Please use \`/config provider switch\` to set one up.`,
...
2. Regenerate without web search (choose "No" when asked)`,
        ...
        api_key_decrypt_failed_description: `Failed to decrypt the active provider credentials. Please reconfigure them using \`/config provider switch\`.`,
...
Optional. After setup, use \`/config provider add\` or \`/config provider switch\` to store a Bearer token.
...
\`\`\``,
      ...
      preset: {
        text: {
          ...
          not_novelai_description: `This command only works when your AI provider is set to NovelAI. Use \`/config provider switch\` to switch providers.`,
...
\`\`\``,
    ...
    bot: {
      ...
      respond: {
        ...
        no_smart_model_description: `No reasoning model found for your current AI provider. Please switch to a provider that supports reasoning models using \`/config provider switch\`.`,
    ...
    config: {
      ...
      "api-key": {
        ...
        rotation: {
          ...
          no_main_key_description: `You must switch to a provider with active credentials using \`/config provider switch\` before adding rotation keys.`,
      ...
      provider: {
        ...
        add: {
          ...
          success: `Saved credentials for **{provider}**. You can switch to this provider later with \`/config provider switch\`.`,
...
Restored now ({restored_count}): {restored_list}`,
      ...
      samplers: {
        ...
        provider_not_saved_description: `No saved configuration exists for **{provider}**. Add it first with \`/config provider add\` or switch to it with \`/config provider switch\`.`,
      ...
      model: {
        ...
        text: {
          ...
          no_api_key_description: `An active provider must be configured before changing models. Please use \`/config provider switch\` first.`,
          ...
          api_key_incompatible_description: `The current provider credentials are not compatible with the {model_name} model from {provider}. Please switch to valid credentials for {provider} using \`/config provider switch\`.`,
          validation_error_title: `Validation Error`,
...
{model_list}`,
      ...
      setup: {
        ...
        already_setup_description: `I am already set up for this server. To modify my configuration, please use other commands like \`/config\`, \`/persona\`, \`/memory\`, and \`/server\`.
				...
				If you wish to swap my provider, use the \`/config provider switch\` command.`,
      },
      params: {
    ...
    memory: {
      ...
      history: {
        ...
        import: {
          ...
          no_api_key_title: `No API Key Set`,
          no_api_key_description: `Saved embedding provider credentials are required to extract and embed history. Please use \`/config provider add\` or \`/config provider switch\`.`,
          no_messages_title: `No Messages Found`,
...
> {bot_input}`,
      ...
      document: {
        ...
        no_api_key_title: `No API Key Set`,
        no_api_key_description: `Saved embedding provider credentials are required to embed documents. Please use \`/config provider add\` or \`/config provider switch\`.`,
...
**Warning:** Personalization is currently disabled on this server, so this change won't affect my behavior here. It will still be reflected on other servers where personalization is enabled.`,
    ...
    generate: {
      image: {
        ...
        no_api_key_title: `🔴 No API Key`,
        no_api_key_description: `No saved credentials are available for the configured image provider. Use \`/config provider add\` or \`/config provider switch\`.`,
        api_key_decrypt_failed_title: `🔴 API Key Error`,
        api_key_decrypt_failed_description: `Failed to decrypt the configured image provider credentials. Please reconfigure them using \`/config provider add\` or \`/config provider switch\`.`,
...
**Prompt:** {prompt}`,
        ...
        no_api_key_title: `🔴 No API Key`,
        no_api_key_description: `No saved credentials are available for the configured video provider. Use \`/config provider add\` or \`/config provider switch\`.`,
        api_key_decrypt_failed_title: `🔴 API Key Error`,
        api_key_decrypt_failed_description: `Failed to decrypt the configured video provider credentials. Please reconfigure them using \`/config provider add\` or \`/config provider switch\`.`,
