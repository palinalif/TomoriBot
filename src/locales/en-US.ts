	...
	commands: {
		...
		tool: {
			...
			status: {
				...
				// Server scope (3 pages)
				server_title: `Server Status`,
				server_description: `Server configuration, personality, and memories`,
				server_page1_title: `Server Status — Configuration`,
				server_page1_description: `Core model settings and auto-chat configuration`,
				server_page2_title: `Server Status — Features & Moderation`,
				server_page2_description: `Feature toggles and moderation settings`,
				server_page3_title: `Server Status — Memory & Prompt`,
				server_page3_description: `Server memories and active system prompt`,
				// Persona scope (persona picker + 2 pages)
				persona_page1_title: `{persona_name} — Identity`,
				persona_page1_description: `Persona identity, triggers, and attributes`,
				persona_page2_title: `{persona_name} — Prompt & Tags`,
				persona_page2_description: `Persona prompt and generation tags`,
				// Shared fields
...
- Export your persona to back it up or share with other servers!`,
		...
		config: {
			...
			params: {
				...
				temperature: {
					description: `Set the creativity/randomness of my responses (1.0-2.0).`,
				...
				"top-k": {
					description: `Set the top-K (candidate token count) limit.`,
				...
				"frequency-penalty": {
					description: `Set the frequency penalty for repeated tokens.`,
		...
		server: {
			...
			cooldown: {
				...
				triggers: {
					description: `Set both cooldown type and duration for message triggers and /bot commands.`,
					cooldown_type_description: `How cooldowns apply (off, per-user, per-channel, server-wide).`,
					cooldown_length_description: `Cooldown duration in seconds (1-86400).`,
					invalid_type_title: `Invalid Cooldown Type`,
					invalid_type_description: `The selected cooldown type is invalid. Please choose a valid option.`,
