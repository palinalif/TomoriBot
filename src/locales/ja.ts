...
export default {
  ...
  genai: {
    ...
    text_quota_exceeded_description:
      `テキスト生成クォータに達しました。{reset_info}`,
    text_user_quota_exceeded_description:
      `日次テキスト生成クォータに達しました。{reset_info}`,
    text_serverwide_quota_exceeded_description:
      `このサーバーはこの期間のテキスト生成クォータに達しました。{reset_info}`,
...
- 自動トリガーチャンネルを制限する`,
      ...
      status: {
        ...
        field_whitelist_channels: `トリガーホワイトリスト`,
...
- ペルソナをエクスポートしてバックアップするか、他のサーバーと共有！`,
    ...
    bot: {
      respond: {
        ...
        channel_not_whitelisted: `このサーバーではチャンネルホワイトリストが有効です。\`/bot respond\` はホワイトリストに登録されたチャンネルでのみ使用できます。`,
      },
      kill: {
      ...
      impersonate: {
        ...
        channel_not_whitelisted: `このサーバーではチャンネルホワイトリストが有効です。\`/bot impersonate me\` はホワイトリストに登録されたチャンネルでのみ使用できます。`,
        channel_not_whitelisted_user: `このサーバーではチャンネルホワイトリストが有効です。\`/bot impersonate user\` はホワイトリストに登録されたチャンネルでのみ使用できます。`,
    ...
    config: {
      ...
      maxmsgfetch: {
        description: `コンテキスト用に取得する最近のメッセージ数を設定します (20-100)。`,
        limit_description: `コンテキスト用に取得する最近のメッセージ数 (20-100)。`,
        limit: {
          description: `コンテキスト用に取得する最近のメッセージ数の上限を設定します。`,
          limit_description: `コンテキスト用に取得する最近のメッセージ数 (20-100)。`,
          invalid_range_title: `無効な上限値`,
          invalid_range_description: `上限は {min} 〜 {max} の範囲で指定してください。`,
          already_set_title: `既に設定済み`,
      ...
      params: {
        ...
        temperature: {
          description: `私の応答の創造性/ランダム性を設定します（1.0〜2.0）。`,
        ...
        "top-p": {
          description: `Top-P（核サンプリング）のしきい値を設定します。`,
        ...
        "top-k": {
          description: `Top-K（候補トークン数）の上限を設定します。`,
        ...
        "frequency-penalty": {
          description: `繰り返しトークンへの頻度ペナルティを設定します。`,
          value_description: `頻繁に使用されるトークンへのペナルティ（-2.0〜2.0、0.0=中立）。デフォルト: 0.0。`,
          ...
          success_description: `Frequency penaltyが \`{previous_frequency_penalty}\` から \`{frequency_penalty}\` に変更されました。\n**対応プロバイダー:** OpenRouterおよびNovelAI`,
        },
        "presence-penalty": {
          description: `繰り返しトピックへの存在ペナルティを設定します。`,
          value_description: `既に言及されたトピックへのペナルティ（-2.0〜2.0、0.0=中立）。デフォルト: 0.0。`,
        ...
        "min-p": {
          description: `Min-P（最小確率）のしきい値を設定します。`,
      ...
      randomtrigger: {
        ...
        remove: {
          ...
          success_title: `ランダムトリガーを削除しました`,
          success_description: `{channel}のランダムトリガーが削除されました。`,
        },
      },
      ...
      remove: {
        ...
        modeloverride: {
          ...
          channel_none_title: `チャンネル上書きなし`,
          channel_none_description: `このサーバーにはチャンネルモデル上書きが設定されていません。`,
          channel_success_title: `チャンネル上書きを削除しました`,
          channel_success_description: `{channel}のモデル上書きが削除されました。サーバーデフォルトが使用されます。`,
          persona_modal_title: `ペルソナモデル上書きの削除`,
          persona_select_label: `削除するペルソナ上書き`,
          persona_select_placeholder: `ペルソナを選択...`,
          persona_none_title: `ペルソナ上書きなし`,
        ...
        modelfallback: {
          ...
          select_label: `削除するフォールバック`,
          select_placeholder: `フォールバックモデルを選択...`,
    ...
    server: {
      ...
      quota: {
        ...
        textgen: {
          ...
          daily_user_quota_limit_description: `ユーザー1人あたりの日次テキストトリガー数（0 = 無制限、1-100）。`,
          daily_user_quota_success_title: `ユーザークォータが更新されました`,
          ...
          serverwide_quota_limit_description: `サーバー全体のテキストトリガー数（0 = 無制限、1-99999）。`,
          serverwide_quota_success_title: `サーバー全体のクォータが更新されました`,
      ...
      matrix: {
        link: {
          ...
          join_failed_description: `<#{channel_id}>が\`{room_id}\`にリンクされましたが、Matrixルームに自動的に参加できませんでした。\`{bot_user_id}\`をルームに手動で招待してください。`,
