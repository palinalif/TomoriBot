    ...
    server: {
      config: {
        ...
        import: {
          ...
          confirmation_description: `このファイルをインポートしてよいか確認します。`,
...
セットアップ手順、Matrix側で使えるコマンド、現在の制限一覧は {help_matrix} を確認してください。`,
    ...
    personal: {
      ...
      reminder: {
        description: `個人用リマインダーを管理します。`,
        remove: {
          description: `あなたのリマインダーを1件削除します。`,
        },
      },
      privacy: {
...
**警告:** 現在、このサーバーではパーソナライズが無効になっているため、この変更はここでの私の行動に影響しません。パーソナライズが有効になっている他のサーバーでは反映されます。`,
  ...
  reminders: {
    ...
    reminder_set_footer: `{time_remaining}後にメンションを送信します。リマインダーは\`/personal reminder remove\`で削除できます。`,
    reminder_set_footer_recurring: `最初のメンションは{time_remaining}後です。{repetition_interval_hours}時間ごとに繰り返します。リマインダーは\`/personal reminder remove\`で削除できます。`,
    ...
    recurring_task_set_footer: `リマインダーは\`/personal reminder remove\`で削除できます。`,
    ...
    task_set_footer: `{time_remaining}後にタスクを実行します。リマインダーは\`/personal reminder remove\`で削除できます。`,
