...
- ペルソナをエクスポートしてバックアップするか、他のサーバーと共有！`,
    ...
    bot: {
      ...
      impersonate: {
        ...
        user_impersonation_notice_description: `\`/config bot-permissions\`で「なりすまし埋め込みを非表示」権限を有効にすると、この埋め込みを非表示にできます。あなたをどうなりすますか教えるには、\`/personal impersonate prompt\`を設定してください。`,
