...
- 自動トリガーチャンネルを制限する`,
		...
		persona: {
			...
			export: {
				...
				export_json_description: `PNGメタデータの代わりに読み取り用JSONファイルとしてエクスポートする`,
		...
		config: {
			...
			randomtrigger: {
				add: {
					...
					success_description: `{channel}を**{timer_hours}時間**ごとに確認し、**{chance}%**の確率で**{persona}**として発言します。{silence_suffix}`,
