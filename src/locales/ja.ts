    ...
    config: {
      ...
      custom_models: {
        ...
        capability_modal: {
          ...
          text_capabilities_placeholder: `tools, vision, structoutput — カンマ区切り。なしの場合は空欄`,
          script_markup_label: `スクリプトマークアップ形式`,
          script_markup_placeholder: `plain, bracket-tags, または emoji`,
          supports_instruct_label: `指示対応`,
          supports_instruct_placeholder: `yes または no`,
