...
export default {
	...
	genai: {
		...
		self_teach: {
			server_memory_learned_title: "🧠 このサーバーで新しいことを学びました！",
			server_memory_learned_description:
				"`{memory_content}`",
			server_memory_updated_title: "📝 サーバーの記憶を更新しました！",
	...
	commands: {
		...
		persona: {
			...
			import: {
				...
				memories_description: `このペルソナのユーザーに関する記憶を引き継ぎますか？`,
				memories_choice_preserve: `はい（ユーザー記憶を引き継ぐ）`,
				memories_choice_fork: `いいえ（ユーザー記憶を新しく開始する）`,
...
> {bot_input}`,
			...
			document: {
				...
				scope_description: `この文書をペルソナ専用にするか、サーバー全体で共有するかを選択します。`,
