...
今回再表示した項目（{restored_count}）: {restored_list}`,
      ...
      "stop-strings": {
        description: `プロバイダーの停止文字列を管理します。`,
        add: {
          description: `保存済みプロバイダーに停止文字列を追加します。`,
          strings_description: `追加する停止文字列。複数指定する場合はカンマで区切ります。改行は \\n を使えます。`,
          picker_description: `停止文字列を追加する保存済みプロバイダーを選択してください。`,
          ...
          too_many_description: `このプロバイダーに保存できる停止文字列は最大 {max_count} 件です。現在 {current_count} 件あり、このコマンドでは {added_count} 件追加されます。`,
          no_changes_title: `追加する停止文字列はありません`,
          no_changes_description: `指定された停止文字列はすでにこのプロバイダーに保存されています。`,
          success_title: `停止文字列を追加しました`,
          success_description: `**{provider}** に停止文字列を {added_count} 件追加しました: {stop_strings}`,
          more_added: `ほか {count} 件`,
        },
        manage: {
          description: `保存済み停止文字列と話者パターン停止を管理します。`,
          picker_description: `停止文字列を管理する保存済みプロバイダーを選択してください。`,
          ...
          too_many_title: `停止文字列が多すぎます`,
          too_many_description: `このプロバイダーには {count} 件の停止文字列があり、モーダル上限の {max_entries} 件を超えています。`,
          no_changes_title: `変更はありません`,
          no_changes_description: `停止文字列設定はすでにその状態です。`,
          success_title: `停止文字列を更新しました`,
          success_description: `**{provider}** の停止文字列設定を更新しました。
