...
export default {
  ...
  genai: {
    ...
    stream: {
      ...
      content_blocked_tip:
        "ヒント: `/config jailbreaks` でこのエラーの回避を試すか、メッセージ(`/tool refresh`)、性格/記憶(`/data export`)、問題のあるメンバーをブラックリスト(`/server blacklist`)、またはプロバイダを変更(`/config model`)を確認してください。",
...
- ペルソナをエクスポートしてバックアップするか、他のサーバーと共有！`,
    ...
    server: {
      ...
      privatechannel: {
        ...
        remove: {
          description: `プライベートチャンネルを確認し、削除したいもののチェックを外します。`,
          ...
          checkbox_description: `削除したいプライベートチャンネルのチェックを外してください。`,
          no_channels_title: `プライベートチャンネルはありません`,
          no_channels_description: `削除できるプライベートチャンネルは設定されていません。`,
          too_many_entries_title: `プライベートチャンネルが多すぎます`,
          too_many_entries_description: `設定済みのプライベートチャンネルは {channel_count} 件です。この一括管理モーダルは {max_groups} グループ、最大 {max_entries} 件まで対応します。`,
          no_changes_title: `プライベートチャンネルは削除されませんでした`,
          no_changes_description: `すべてのプライベートチャンネルがチェックされたままだったため、削除された項目はありません。`,
          success_title: `プライベートチャンネルが削除されました`,
          success_description: `プライベートチャンネルを **{removed_count}** 件削除しました: {removed_channels}\n設定済みのプライベートチャンネルは **{remaining_count}** 件残っています。`,
      ...
      rpchannel: {
        ...
        remove: {
          description: `RPチャンネルを確認し、削除したいもののチェックを外します。`,
          ...
          checkbox_description: `削除したいRPチャンネルのチェックを外してください。`,
          no_channels_title: `RPチャンネルはありません`,
          no_channels_description: `削除できるRPチャンネルは設定されていません。`,
          too_many_entries_title: `RPチャンネルが多すぎます`,
          too_many_entries_description: `設定済みのRPチャンネルは {channel_count} 件です。この一括管理モーダルは {max_groups} グループ、最大 {max_entries} 件まで対応します。`,
          no_changes_title: `RPチャンネルは削除されませんでした`,
          no_changes_description: `すべてのRPチャンネルがチェックされたままだったため、削除された項目はありません。`,
          success_title: `RPチャンネルが削除されました`,
          success_description: `RPチャンネルを **{removed_count}** 件削除しました: {removed_channels}\n設定済みのRPチャンネルは **{remaining_count}** 件残っています。`,
          not_found_title: `チャンネルが見つかりません`,
