    ...
    openrouter: {
      ...
      models: {
        ...
        add: {
          ...
          success_description: `このサーバー用に OpenRouter モデル \`{model_name}\` を登録しました。通常の OpenRouter モデル選択一覧に表示されます。`,
          already_registered_title: `既に登録されています`,
          already_registered_description: `OpenRouter モデル \`{model_name}\` はこのサーバーに既に登録されています。`,
          already_available_title: `最初から利用可能です`,
          already_available_description: `OpenRouter モデル \`{model_name}\` は最初から組み込み済みです。追加登録は不要です。`,
        ...
        remove: {
          ...
          model_name_description: `削除する登録済みOpenRouterモデルコードネーム。`,
          success_title: `OpenRouterモデルを削除しました`,
          success_description: `このサーバーの保存済みOpenRouterモデル一覧から \`{model_name}\` を削除しました。`,
          success_still_referenced_description: `このサーバーの保存済みOpenRouterモデル一覧から \`{model_name}\` を削除しました。すでにそれを使っている既存の選択はそのまま残るため、もう使わない場合は手動で別モデルへ切り替えてください。`,
          not_found_description: `このサーバーに登録された OpenRouter モデル \`{model_name}\` は見つかりませんでした。`,
...
{model_list}`,
        ...
        image: {
          ...
          nai_only_description: `保存済みの画像プロバイダーはNovelAIのみです。NovelAI画像モデルは別途設定します — \`/novelai image model\` を使用してモデルを選択してください。`,
          nai_picker_note: `NovelAI画像モデルは \`/novelai image model\` で設定します。`,
        },
        video: {
    ...
    personal: {
      ...
      openrouter_models: {
        ...
        add: {
          ...
          success_description: `個人用プロバイダー一覧に OpenRouter モデル \`{model_name}\` を登録しました。通常の OpenRouter モデル選択一覧に表示されます。`,
          already_registered_title: `既に登録されています`,
          already_registered_description: `OpenRouter モデル \`{model_name}\` は個人用プロバイダー一覧に既に登録されています。`,
          already_available_title: `最初から利用可能です`,
          already_available_description: `OpenRouter モデル \`{model_name}\` は最初から組み込み済みです。追加登録は不要です。`,
          not_found_title: `モデルが見つかりません`,
          not_found_description: `OpenRouter モデル \`{model_name}\` が見つかりませんでした。正確なOpenRouterコードネームを入力して再試行してください。`,
        ...
        remove: {
          ...
          success_description: `個人用の保存済みOpenRouterモデル一覧から \`{model_name}\` を削除しました。`,
          success_still_referenced_description: `個人用の保存済みOpenRouterモデル一覧から \`{model_name}\` を削除しました。すでにそれを使っている既存の選択はそのまま残るため、もう使わない場合は手動で別モデルへ切り替えてください。`,
          not_found_description: `個人用プロバイダー一覧に登録された OpenRouter モデル \`{model_name}\` は見つかりませんでした。`,
          already_available_title: `組み込みモデルです`,
          already_available_description: `OpenRouter モデル \`{model_name}\` は組み込みモデルなので、このコマンドでは削除できません。`,
        },
      },
      ...
      model: {
        ...
        fallback: {
          description: `有効な個人テキストプロバイダーのフォールバックモデルを設定します。`,
