...
export default {
  general: {
    ...
    errors: {
      ...
      api_key_missing_description: `機能するには有効なプロバイダー設定が必要ですが、このサーバーには設定されていません。\`サーバー管理\`権限を持つメンバーが\`/config provider switch\`で設定できます。`,
      api_key_error_title: `APIキーエラー`,
      api_key_error_description: `設定されたプロバイダー認証情報へのアクセスまたは復号化で問題が発生しました。\`/config provider switch\`で再設定してください。`,
...
トリガーワード ({trigger_word_count}): {triggers}`,
      ...
      generate: {
        ...
        wrong_provider_description: `ペルソナ生成には対応プロバイダーが必要です。現在のプロバイダーは **{current_provider}** です。\`/config provider switch\`でプロバイダーを切り替えてください。`,
        no_api_key_title: `🔴 APIキーがありません`,
        no_api_key_description: `有効なプロバイダーが設定されていません。\`/config provider switch\`で設定してください。`,
...
2. ウェブ検索なしで再生成する（質問されたら「いいえ」を選択）`,
        ...
        api_key_decrypt_failed_description: `有効なプロバイダー認証情報の復号化に失敗しました。\`/config provider switch\`で再設定してください。`,
...
**APIキー / Bearerトークン**
オプションです。セットアップ後に \`/config provider add\` または \`/config provider switch\` でBearerトークンを保存できます。
...
\`\`\``,
      ...
      preset: {
        text: {
          ...
          not_novelai_description: `このコマンドはAIプロバイダーがNovelAIに設定されている場合にのみ使用できます。\`/config provider switch\` でプロバイダーを切り替えてください。`,
...
\`\`\``,
    ...
    bot: {
      ...
      respond: {
        ...
        no_smart_model_description: `現在のAIプロバイダーに推論モデルが見つかりませんでした。\`/config provider switch\`を使用して、推論モデルをサポートするプロバイダーに切り替えてください。`,
    ...
    config: {
      ...
      "api-key": {
        ...
        rotation: {
          ...
          no_main_key_description: `ローテーションキーを追加する前に、\`/config provider switch\`で有効なプロバイダー認証情報に切り替える必要があります。`,
      ...
      provider: {
        ...
        add: {
          ...
          success: `**{provider}** の認証情報を保存しました。後で \`/config provider switch\` で切り替えられます。`,
...
今回再表示した項目（{restored_count}）: {restored_list}`,
      ...
      samplers: {
        ...
        provider_not_saved_description: `**{provider}** の保存済み設定がありません。先に \`/config provider add\` で追加するか、\`/config provider switch\` で切り替えてください。`,
      ...
      model: {
        ...
        text: {
          ...
          no_api_key_description: `モデルを変更する前に有効なプロバイダーを設定する必要があります。まず \`/config provider switch\` を使用してください。`,
          ...
          api_key_incompatible_description: `現在のプロバイダー認証情報は {provider} の {model_name} モデルと互換性がありません。\`/config provider switch\` を使用して {provider} の有効な認証情報に切り替えてください。`,
          validation_error_title: `検証エラー`,
...
{model_list}`,
      ...
      setup: {
        ...
        already_setup_description: `このサーバーでは既に設定が完了しています。設定を変更するには、\`/config\`、\`/persona\`、\`/memory\`、\`/server\`などの他のコマンドを使用してください。
				...
				プロバイダーを変更したい場合は、\`/config provider switch\`コマンドを使用してください。`,
      },
      params: {
    ...
    memory: {
      ...
      history: {
        ...
        import: {
          ...
          no_api_key_description: `履歴の抽出と埋め込みには保存済みの埋め込みプロバイダー認証情報が必要です。\`/config provider add\` または \`/config provider switch\` で設定してください。`,
          no_messages_title: `メッセージが見つかりません`,
...
> {bot_input}`,
      ...
      document: {
        ...
        no_api_key_title: `APIキーがありません`,
        no_api_key_description: `文書を埋め込むには保存済みの埋め込みプロバイダー認証情報が必要です。\`/config provider add\` または \`/config provider switch\` を使用してください。`,
...
**警告:** 現在、このサーバーではパーソナライズが無効になっているため、この変更はここでの私の行動に影響しません。パーソナライズが有効になっている他のサーバーでは反映されます。`,
    ...
    generate: {
      image: {
        ...
        no_api_key_title: `🔴 APIキーがありません`,
        no_api_key_description: `設定済みの画像プロバイダー認証情報がありません。\`/config provider add\` または \`/config provider switch\` を使用してください。`,
        api_key_decrypt_failed_title: `🔴 APIキーエラー`,
        api_key_decrypt_failed_description: `設定済みの画像プロバイダー認証情報の復号化に失敗しました。\`/config provider add\` または \`/config provider switch\` で再設定してください。`,
...
**プロンプト:** {prompt}`,
        ...
        no_api_key_title: `🔴 APIキーがありません`,
        no_api_key_description: `設定済みの動画プロバイダー認証情報がありません。\`/config provider add\` または \`/config provider switch\` を使用してください。`,
        api_key_decrypt_failed_title: `🔴 APIキーエラー`,
        api_key_decrypt_failed_description: `設定済みの動画プロバイダー認証情報の復号に失敗しました。\`/config provider add\` または \`/config provider switch\` で再設定してください。`,
