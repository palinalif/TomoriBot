...
- ペルソナをエクスポートしてバックアップするか、他のサーバーと共有！`,
		...
		config: {
			...
			sysprompt: {
				...
				show: {
					description: `現在のシステムプロンプトを表示します`,
				},
			},
			prompt: {
				description: `人格指示のためのカスタムシステムプロンプトを管理します`,
				...
				show: {
					description: `現在のシステムプロンプトを表示します`,
					custom_title: `現在のシステムプロンプト`,
					custom_description: `\`\`\`\n{prompt}\n\`\`\``,
					default_title: `システムプロンプト（デフォルト）`,
					default_description: `カスタムシステムプロンプトは設定されていません。現在はデフォルトを使用しています：\n\`\`\`\n{defaultPrompt}\n\`\`\``,
				},
			},
			personaprompt: {
				description: `ペルソナ専用プロンプトを表示します`,
				show: {
					description: `指定したペルソナの現在のプロンプトを表示します`,
					no_permission_title: `🔴 権限がありません`,
					no_permission_description: `ペルソナプロンプトを表示するには**サーバー管理**権限が必要です。`,
					set_title: `ペルソナプロンプト：{persona_name}`,
					set_description: `\`\`\`\n{prompt}\n\`\`\``,
					empty_title: `ペルソナプロンプト：{persona_name}`,
					empty_description: `**{persona_name}** にはペルソナプロンプトが設定されていません。`,
				},
			},
		},
