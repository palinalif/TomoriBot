	...
	commands: {
		...
		tool: {
			...
			status: {
				...
				server_page1_title: `サーバーステータス — 設定`,
				server_page1_description: `コアモデル設定と自動チャット設定`,
				server_page2_title: `サーバーステータス — 機能・モデレーション`,
				server_page2_description: `機能トグルとモデレーション設定`,
				server_page3_title: `サーバーステータス — 記憶とプロンプト`,
				server_page3_description: `サーバーの記憶とアクティブなシステムプロンプト`,
				// ペルソナスコープ（ペルソナ選択＋2ページ）
				persona_page1_title: `{persona_name} — アイデンティティ`,
				persona_page1_description: `ペルソナのアイデンティティ、トリガー、属性`,
				persona_page2_title: `{persona_name} — プロンプトとタグ`,
				persona_page2_description: `ペルソナプロンプトと生成タグ`,
				// 共通フィールド
				field_model: `AIモデル`,
