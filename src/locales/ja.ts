...
- ペルソナをエクスポートしてバックアップするか、他のサーバーと共有！`,
		...
		bot: {
			respond: {
				...
				prefill_description: `最後のコンテキストとして追加される任意のアシスタントプリフィル。`,
...
> {bot_input}`,
			...
			document: {
				description: `このサーバーで参照できる文書を教えます。`,
				...
				success_description: `**{name}** を保存しました（{chunk_count} チャンク）。ドキュメントID: {document_id}`,
			},
			memory: {
				description: `私の記憶を管理`,
				personal: {
