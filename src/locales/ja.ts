...
Discord API 遅延: \`{discord_response}ms\``,
			...
			status: {
				description: `現在の設定または人格のステータスを表示します。`,
				type_description: `どのステータスを表示しますか？`,
				type_choice_config: `設定`,
				type_choice_personality: `人格`,
				config_title: `設定ステータス`,
				config_description: `現在の運用設定`,
				personality_title: `人格ステータス`,
				personality_description: `現在の人格設定`,
				field_model: `AIモデル`,
				...
				field_server_memory_count: `サーバーの記憶`,
				field_attributes: `属性`,
				item_count: `{count} 件`,
				none: `なし`,
				disabled: `無効`,
		...
		config: {
			...
			memberpermissions: {
				...
				enabled_success: `メンバーは अब \`{permission_type}\` を教えることができます。`,
...
{items}`,
			...
			rename: {
				...
				already_set_description: `私の名前は既に \`{name}\` に設定されています。`,
				success_title: `名前が更新されました`,
				success_description: `私の名前が \`{old_name}\` から \`{new_name}\` に変更されました。`,
				success_with_trigger_description: `私の名前が \`{old_name}\` から \`{new_name}\` に変更されました。トリガーワードもそれに合わせて更新されました。`,
				partial_success_title: `名前は更新されましたが問題あり`,
				partial_success_description: `私の名前は \`{new_name}\` に変更されましたが、一部のトリガーワードの更新に失敗しました。`,
			},
			setup: {
		...
		teach: {
			sampledialogue: {
				...
				teaching_disabled_description: `現在、このサーバーではメンバーがサンプル対話を教えることは許可されていません。\`サーバー管理\`権限を持つメンバーが\`/config memberpermissions\`でこれを有効にできます。`,
				...
				bot_input_description: `ボットがどのように応答すべきか（例：わ、わたしはマンゴーが好きです…）`,
...
> {bot_input}`,
			...
			attribute: {
				...
				teaching_disabled_description: `現在、このサーバーではメンバーが人格属性を教えることは許可されていません。\`サーバー管理\`権限を持つメンバーが\`/config memberpermissions\`でこれを有効にできます。`,
				modal_title: `人格属性の追加`,
				modal_description: `このサーバーでの私の人格特性（例：マンゴーが好き）`,
			...
			servermemory: {
				...
				teaching_disabled_description: `現在、このサーバーではメンバーがサーバーの記憶を追加することは許可されていません。\`サーバー管理\`権限を持つメンバーが\`/config memberpermissions\`でこれを有効にできます。`,
				modal_title: `サーバーの記憶の追加`,
				modal_description: `このサーバーだけで私が覚えている記憶（例：このサーバーのメンバーはマンゴーが好き）`,
			...
			personalmemory: {
				...
				modal_description: `どのサーバーでも私が覚えているあなたの記憶（例：マンゴーが好き）`,
