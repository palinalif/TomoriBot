...
Discord API 遅延: \`{discord_response}ms\``,
		...
		data: {
			...
			export: {
				...
				success_description_personality: `トモリボットの性格がエクスポートされ、DMに送信されました！\n\n**注意:** このエクスポートは情報提供のみを目的としています。性格をインポートするには、代わりに\`/preset\`コマンドを使用してください。`,
				...
				dm_description_personality: `リクエストされた性格情報をお送りします！\n\n**注意:** このテキストファイルは情報提供のみを目的としています。サーバーに性格をインポートするには、代わりに\`/preset\`コマンドを使用してください。`,
			...
			delete: {
				...
				no_data_title: `ℹ️ データが見つかりません`,
				no_data_description: `データベースに個人データが保存されていません。`,
				no_server_data_title: `ℹ️ サーバーデータが見つかりません`,
		...
		// プリセットコマンド
		preset: {
			description: `Tomoriの人格プリセットを管理する`,
			export: {
				description: `Tomoriの人格を共有可能なPNGファイルとしてエクスポートする`,
				success_title: `✅ プリセットのエクスポートに成功しました`,
				success_description: `Tomoriプリセット **{nickname}** がエクスポートされました！このPNGファイルを他の人と共有して、人格設定を広めましょう。`,
				failed_title: `❌ エクスポートに失敗しました`,
				failed_description: `プリセットのエクスポートに失敗しました。後でもう一度お試しください。`,
				...
				error_no_preset_data: `プリセットデータが見つかりません。まず /config setup を実行してください。`,
				error_validation_failed: `エクスポートデータ構造の検証に失敗しました`,
				error_export_failed: `プリセットデータのエクスポートに失敗しました`,
			},
			import: {
				description: `PNGファイルからTomoriの人格をインポートする`,
				file_description: `Tomoriプリセットデータを含むPNGファイル`,
				confirmation_description: `警告：現在の人格設定が置き換えられます。続行しますか？`,
				confirmation_choice_yes: `はい、現在のプリセットを置き換えます`,
				confirmation_choice_no: `いいえ、インポートをキャンセルします`,
				success_title: `✅ プリセットのインポートに成功しました`,
				success_description: `プリセット **{nickname}** が正常にインポートされました！\n📝 属性: {attribute_count}\n💬 サンプル対話: {dialogue_count}\n🔔 トリガーワード: {trigger_word_count}\n\n**注意：** 権限が許可されている場合、サーバーアバターとニックネームも更新されました。`,
				failed_title: `❌ インポートに失敗しました`,
				failed_description: `プリセットのインポートに失敗しました。ファイルを確認してもう一度お試しください。`,
				cancelled_title: `❌ インポートがキャンセルされました`,
				cancelled_description: `インポートがキャンセルされました。プリセットに変更はありませんでした。`,
				invalid_file_type_title: `❌ 無効なファイル形式`,
				invalid_file_type_description: `Tomoriプリセットデータを含む有効な.pngファイルをアップロードしてください。`,
				file_too_large_title: `❌ ファイルが大きすぎます`,
				...
				no_metadata_title: `❌ プリセットデータが見つかりません`,
				no_metadata_description: `このPNGファイルにはTomoriプリセットデータが含まれていません。\`/preset export\`でエクスポートされたファイルを使用してください。`,
				invalid_file_title: `❌ 無効なプリセットファイル`,
				invalid_file_description: `プリセットファイル形式が無効または互換性がありません。`,
				no_permission_title: `🔒 権限がありません`,
				no_permission_description: `プリセットをインポートするには**サーバー管理**権限が必要です。`,
				...
				error_invalid_config: `プリセットデータに無効な設定フィールドがあります`,
				error_no_server_data: `データベースにサーバーが見つかりません。まず /config setup を実行してください。`,
				error_import_failed: `プリセットデータのインポートに失敗しました`,
				error_not_json: `プリセットファイルには有効なJSONデータが含まれている必要があります`,
				error_incompatible_version: `互換性のないプリセットバージョン。期待: {expected}、実際: {actual}`,
				error_invalid_format: `無効なプリセットファイル形式`,
				error_invalid_type: `無効なプリセットタイプ: {type}。"preset"が期待されます`,
				avatar_update_skipped_dm: `ℹ️ 注意: アバターとニックネームの更新はダイレクトメッセージでは利用できません。プリセットが正常にインポートされました。`,
			},
			default: {
			...
			generate: {
				...
				wrong_provider_description: `プリセット生成にはGoogle Geminiが必要です。現在のプロバイダーは **{current_provider}** です。\`/config apikeyset\`を使用してGoogleに切り替えてください。`,
			...
			create: {
				...
				image_download_failed_description: `添付画像のダウンロードに失敗しました。もう一度お試しください。`,
				validation_failed_title: `❌ 検証に失敗しました`,
				validation_failed_description: `プリセットデータの検証に失敗しました。もう一度お試しください。`,
				image_processing_failed_title: `❌ 画像処理に失敗しました`,
				image_processing_failed_description: `アップロードされた画像の処理に失敗しました。別の画像をお試しください。`,
				avatar_fetch_failed_title: `❌ アバターの取得に失敗しました`,
				avatar_fetch_failed_description: `エクスポート用のサーバーアバターの取得に失敗しました。代わりに画像をアップロードしてみてください。`,
				...
				success_description: `**{character_name}** のプリセットが作成されました！\n\n**説明:**\n{character_description}`,
				success_dialogue_title: `💬 サンプル対話`,
				success_next_steps_title: `📥 次のステップ`,
				success_next_steps_description: `1. 添付されたPNGファイルをダウンロード\n2. PNGファイルと共に\`/preset import\`を使用してこのキャラクターをインポート\n3. (任意) \`/teach\`コマンドを使用してさらに深みと例を追加`,
				avatar_update_skipped_dm: `ℹ️ 注意: アバターとニックネームの更新はダイレクトメッセージでは利用できません。プリセットが正常に作成されました。`,
			},
		},
