...
Discord APIレイテンシ：\`{discord_response}ms\``,
		...
		config: {
			...
			triggeradd: {
				command_description: `メンションされたときにTomoriが反応する単語を追加します。`,
			...
			autochchannels: {
				command_description: `Tomoriが自動的にチャットするチャンネルを追加または削除します。`,
			...
			autochthreshold: {
				command_description: `Tomoriが自動チャットするメッセージ数の閾値を設定します（0で無効）。`,
			...
			blacklist: {
				command_description: `メンバーをパーソナライゼーションブラックリストに追加または削除します。`,
			...
			humanizerdegree: {
				command_description: `Tomoriの応答がどの程度「人間らしく」感じるかを設定します。`,
			...
			memberpermissions: {
				command_description: `非管理者メンバーがTomoriに教えることができることを設定します。`,
			...
			model: {
				command_description: `Tomoriが使用する基盤AIモデルを変更します。`,
			...
			nickname: {
				command_description: `Tomoriが自分自身に使用する名前を変更します。`,
			...
			apikeydelete: {
				command_description: `現在設定されているGemini APIキーを削除します。`,
			...
			triggerdelete: {
				command_description: `メンションされたときにTomoriが反応する単語を削除します。`,
...
{items}`,
			...
			apikeyset: {
				command_description: `このサーバーのGoogle Gemini APIキーを設定します。`,
			...
			setup: {
				command_description: `Tomoriの初期設定プロセスを開始します。`,
			...
			temperature: {
				command_description: `Tomoriの応答の創造性/ランダム性を設定します（0.1-2.0）。`,
			...
			preset: {
				command_description: `Tomoriにプリセットパーソナリティ設定を適用します`,
...
{items}`,
			...
			tomoripermissions: {
				command_description: `このサーバーでのTomoriのコア動作権限を設定します。`,
		...
		teach: {
			sampledialogue: {
				command_description: `Tomoriの記憶にサンプルユーザー/ボット対話ペアを追加します。`,
...
> {bot_input}`,
			...
			attribute: {
				command_description: `Tomoriの記憶にパーソナリティ属性を追加します。`,
			...
			servermemory: {
				command_description: `Tomoriの知識にサーバー記憶を追加します。`,
			...
			personalmemory: {
				command_description: `あなただけが見ることができる個人記憶を追加します。`,
				modal_title: `個人記憶を追加`,
...
**警告：** このサーバーでは現在パーソナライゼーションが無効になっているため、この記憶はここでは使用されません。パーソナライゼーションが有効な他のサーバーでは引き続き利用できます。`,
			...
			nickname: {
				command_description: `Tomoriがあなたを呼ぶ名前を変更します。`,
...
**警告：** このサーバーでは現在パーソナライゼーションが無効になっているため、ここではこのニックネームを使用しません。パーソナライゼーションが有効な他のサーバーでは引き続き使用します。`,
		...
		unlearn: {
			sampledialogue: {
				command_description: `Tomoriの記憶からサンプルユーザー/ボット対話ペアを削除します。`,
...
{items}`,
			...
			attribute: {
				command_description: `Tomoriの記憶からパーソナリティ属性を削除します。`,
...
{items}`,
			...
			servermemory: {
				command_description: `Tomoriの知識からサーバー記憶を削除します。`,
...
{items}`,
			...
			personalmemory: {
				command_description: `個人記憶を削除します。`,
