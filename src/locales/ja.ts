...
- ペルソナをエクスポートしてバックアップするか、他のサーバーと共有！`,
    ...
    conditioning: {
      ...
      toggle: {
        description: `ペルソナごとの条件付けプロンプト注入を切り替えます。`,
        ...
        already_enabled_description: `{persona_name}の{type_label}はすでに有効です。`,
        already_disabled_description: `{persona_name}の{type_label}はすでに無効です。新しい記録は引き続き保存されます。`,
        success_title: `条件付けを更新しました`,
        enabled_success_description: `{persona_name}は保存済みの{type_label}理由を今後プロンプトに注入します。`,
        disabled_success_description: `{persona_name}は{type_label}を今後プロンプトに注入しませんが、新しい記録は引き続き保存されます。`,
      },
      history: {
