    ...
    novelai: {
      ...
      image: {
        ...
        generate: {
          ...
          prompt_description: `シーン用の画像掲示板タグ形式プロンプトです（例: 1girl, solo, cafe, window light, detailed eyes）。`,
    ...
    server: {
      ...
      whitelist: {
        ...
        remove: {
          ...
          too_many_channels_title: `ホワイトリストのチャンネルが多すぎます`,
          too_many_channels_description: `このサーバーには **{max_channels}** 件を超えるホワイトリストチャンネルがあり、Discord のチェックボックスグループ付きモーダルの上限を超えています。`,
          no_removals_title: `削除されたチャンネルはありません`,
          no_removals_description: `すべてのホワイトリストチャンネルを維持しました。削除は行われていません。`,
          success_title: `チャンネルがホワイトリストから削除されました`,
          success_singular_description: `チャンネル **{channel_name}** をホワイトリストから削除しました。`,
          success_plural_description: `ホワイトリストから **{removed_count}** 件のチャンネルを削除しました: **{channels}**。`,
        },
      },
      cooldown: {
