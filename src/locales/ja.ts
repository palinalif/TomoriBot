...
export default {
	...
	genai: {
		...
		custom: {
			...
			"404_default_message":
				"エンドポイントが見つかりません。エンドポイントURLが正しく、適切なパス（例：/v1/chat/completions）が含まれているか確認してください。",
	...
	commands: {
		...
		persona: {
			...
			import: {
				...
				type_option_main: `メインペルソナ`,
				type_option_alter: `オルタペルソナ`,
			...
			remove: {
				...
				select_description: `{trigger_count} トリガー`,
