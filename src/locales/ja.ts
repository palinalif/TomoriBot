...
- ペルソナをエクスポートしてバックアップするか、他のサーバーと共有！`,
    ...
    novelai: {
      ...
      imggen: {
        description: `このサーバーのNovelAI画像生成パラメータ上書きを管理します。`,
        params: {
          ...
          invalid_scale_title: `無効なScaleです`,
          invalid_scale_description: `Scaleは{min}〜{max}の数値で入力してください。`,
          ...
          invalid_cfg_rescale_title: `無効なCFG Rescaleです`,
          invalid_cfg_rescale_description: `CFG rescaleは{min}〜{max}の数値で入力してください。`,
    ...
    server: {
      ...
      autotrigger: {
        ...
        threshold: {
          description: `自動チャットの閾値を設定します（デフォルト: 0 = 無効）。`,
          threshold_description: `自動チャットまでのメッセージ数（0=無効/デフォルト、または30-100）。`,
