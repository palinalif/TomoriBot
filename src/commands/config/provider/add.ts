  ...
  try {
    const modalComponents: ModalComponent[] = [
      ...
      },
      {
        ...
        labelKey: "commands.config.provider.add.bearer_token_label",
        descriptionKey: "commands.config.provider.add.bearer_token_description",
        placeholder: "commands.config.provider.add.bearer_token_placeholder",
        required: false,
        style: TextInputStyle.Short,
        maxLength: 200,
      },
