...
export async function execute(
  ...
  try {
    ...
    // re-enable via /config bot-permissions. Only fires on provider switch, not key updates.
    ...
    await log.error(`Error executing /config api-key set for user ${userData.user_disc_id}`, error as Error, context);
