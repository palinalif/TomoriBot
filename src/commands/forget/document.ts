	...
	subcommand
		...
		.addStringOption((option) =>
			option
				.setName("scope")
				.setDescription(
					localizer("en-US", "commands.forget.document.scope_description"),
				)
				.addChoices(
					{
						name: localizer(
							"en-US",
							"commands.forget.document.scope_choice_persona",
						),
						value: "persona",
					},
					{
						name: localizer(
							"en-US",
							"commands.forget.document.scope_choice_serverwide",
						),
						value: "serverwide",
					},
				)
