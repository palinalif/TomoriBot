	...
	try {
			...
			components: [
				{
					...
					descriptionKey:
						"commands.novelai.tags.style.tags_input_description",
		...
		if (!validationResult.isValid && validationResult.reason === "too_many") {
			await replyInfoEmbed(modalSubmitInteraction, locale, {
				...
				descriptionKey:
					"commands.novelai.tags.style.too_many_tags_description",
		...
		if (
			...
			await replyInfoEmbed(modalSubmitInteraction, locale, {
				...
				descriptionKey:
					"commands.novelai.tags.style.tag_too_long_description",
